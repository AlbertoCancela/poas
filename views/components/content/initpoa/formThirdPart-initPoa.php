<div id="initPoa-third" class="hidden flex-col p-6 space-y-6 opacity-0 translate-y-4 transition-all duration-300 ease-in-out">
        ...
        <div class="flex space-x-4">
            <div class="flex-1">
                ...
                <div class="flex items-center bg-gray-700 rounded-md border border-gray-600">
                    ...
                    <select id="eje-rector" class="flex-1 bg-gray-800 text-white focus:ring-blue-500 focus:border-blue-500 rounded-md border-none p-2.5">
        ...
        <div>
            ...
            <div class="flex items-center bg-gray-700 rounded-md border border-gray-600">
                ...
                <textarea id="descripcion-general" class="h-36 flex-1 bg-gray-800 text-white focus:ring-blue-500 focus:border-blue-500 rounded-md border-none p-2.5" placeholder="Observaciones"></textarea>
            </div>
        </div>
        ...
        <div class="flex justify-between">
            ...
            <button onclick="initPoa_changeView('initPoa-seconds', 'initPoa-thirds',)" class="hover:bg-green-700 border-2 border-green-600 text-white font-semibold py-2 px-4 rounded-md">
                Finalizar <i class="bi bi-arrow-right-short"></i>
            </button>
        </div>
    </div>